...
<?php foreach ($results as $result): ?>
	<tr>
		...
		<td>
			<?php echo $this->Web->humanName($result['ApprovedBy'], 'first_initial'); ?><br />
			<span class="small light"><?php echo $this->Web->dt($result['Invoice']['date_approved'], 'text_short'); ?></span>
		</td>
		<td><?php echo $this->Web->dt($result['Invoice']['date_due'], 'text_short'); ?></td>
