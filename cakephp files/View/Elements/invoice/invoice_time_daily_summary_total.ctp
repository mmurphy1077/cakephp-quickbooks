...
?>
<tr id="<?php echo $key; ?>-summary-row" class="<?php echo $display_mode; ?> summary-row daily-total <?php echo $display_css; ?>">
	<td colspan="5" class="">
		Daily Total for <?php echo $date; ?>&nbsp;&nbsp;&nbsp;<b><?php echo number_format($data['time'], 2); ?>&nbsp;hours</b>
	</td>
	...
	<td id="data-bank-cell" class="align-right">
		...
		<div id="data-bank-summary-<?php echo $count?>" class="hide data-bank">
			<?php echo $this->Form->hidden('description', array('id' => 'data-bank-item-description', 'class' => 'data-bank-item', 'value' => 'Total for ' . $data['date'])); ?>
