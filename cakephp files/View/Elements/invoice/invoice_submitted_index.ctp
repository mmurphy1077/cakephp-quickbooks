...
<?php foreach ($results as $result): ?>
	<tr>
		...
		<td>
			<?php echo $this->Web->dt($result['Invoice']['date_submitted'], 'text_short'); ?>
			<br />
			<span class="small light">By: <?php echo $this->Web->humanName($result['SubmittedBy'], 'first_initial'); ?></span>
		</td>
