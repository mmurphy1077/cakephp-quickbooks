...
<div id="application_report_container">
	...
	<?php 	foreach($data['Data'] as $key=>$revenue) : ?>
		<div class="revenue_report_table_container">
			<table>
				<tr>
					<th class="nowrap" colspan="6"><b><?php echo 'Job Type: ' . $revenue['name']; ?></b></th>
				</tr>
				...
				<tr>
					...
					<td class="nowrap">
						<?php echo $re['RevenueByOrder']['customer_name']; ?>
						<?php if($display_details && !empty($re['RevenueByOrder']['customer_type'])) : ?>
						<br />
						<span class="light small">(<?php echo $re['RevenueByOrder']['customer_type']; ?>)</span>
						<?php endif; ?>
					</td>
					<td class="nowrap"><?php echo $re['RevenueByOrder']['order_name']; ?></td>
				...
				<tr>
					...
					<td class="nowrap"><b><?php echo '$' . number_format($revenue['total'], 2); ?></b></td>
				</tr>
		</div>
		<?php 	endforeach;?>
	<?php else : ?>
