		...
		<div class="customer_report_table_container">
			<table>
				<tr>
					...
					<th class="align-right nowrap">Score (Comp):&nbsp;&nbsp;<?php echo $customer['Stats']['Score']['score']; ?></th>
				</tr>
				<tr><td class="nowrap" colspan="2">Score (Sales):&nbsp;&nbsp;<?php echo $customer['Stats']['Score']['sales']; ?></td></tr>
				<tr><td class="nowrap" colspan="2">Score (Productivity):&nbsp;&nbsp;<?php echo $customer['Stats']['Score']['productivity']; ?></td></tr>
				<tr><td class="nowrap" colspan="2">Score (Payment):&nbsp;&nbsp;<?php echo $customer['Stats']['Score']['payment']; ?></td></tr>
			</table>
		</div>
		<?php 	endforeach;?>
	<?php else : ?>
