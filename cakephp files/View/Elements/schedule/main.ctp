...
echo $this->element('js'.DS.'jquery', array('ui' => 'col_resize'));
...
<div class="widget center">
	...
	echo $this->Form->hidden('device_display', array('value' => 'standard', 'id' => 'device_display')); 
...
<div id="schedule-table-container" class="left">
		...
		<tr>
			<td id="schedule_container_graph">
				<div id="schedule_container_graph">
					<div id="toggle-schedule-columns">&nbsp;</div>
					<?php 
					#echo $this->Html->image('icon-arrow-right.png', array('id' => 'toggle-schedule-columns', 'class' => 'right'));  
					$order_id = null; 
					echo $this->element('schedule/schedule_table', array('employees' => $employees, 'order_id' => $order_id, 'date_selected' => $date_markers['date_selected'], 'style' => 'standard'));
					?>
				</div>
			...
			<td id="schedule_container_orders">
				<?php echo $this->element('schedule/schedule_right_bar_display'); ?>
			</td>
		</tr>
	</table>
</div>