...
class VcardHelper extends AppHelper {
	var $log;
	...
	public function __construct(View $view, $settings = array()) {
        ...
        if(!empty($settings['card_data'])) {
        	$result = $settings['card_data'];
		    ...
		    $this->data = array(
		      ...
		      ,"work_po_box"=>null
		      ,"work_extended_address"=>$result['work_extended_address']
		      ,"work_address"=>$result['work_address']
		      ,"work_city"=>$result['work_city']
		      ,"work_state"=>$result['work_state']
		      ,"work_postal_code"=>$result['work_postal_code']
		      ,"work_country"=>null
		      ,"home_po_box"=>null
		      ...
		      ,"cell_tel"=>$result['cell_tel']
		      ,"fax_tel"=>$result['fax_tel']
		      ,"pager_tel"=>null
