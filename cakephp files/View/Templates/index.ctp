...
<?php endif; ?>
<div class="grid">
	<div class="col-4of5 dotted-border">
	...
	<div class="col-1of5">
		<div id="index-search-container" class="widget right">
		...
		<div class="widget right">
			...
			switch($this->params['controller']) {
				case 'contacts' :
					echo $this->element('index_filter', array('model' => 'Contact', 'selected_assigned_to' => $filter_selected_assigned_to, 'selected_status' => $filter_selected_status));
					break;
